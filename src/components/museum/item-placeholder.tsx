...
/**
 * Decorative default artwork when an item has no primary image.
 */
    ...
    >
      {isCoin ? (
        ...
        >
          ...
          />
          <path
            d="M42 88c6-10 14-16 18-16s12 6 18 16"
            stroke="currentColor"
            strokeWidth="4"
            strokeLinecap="round"
            fill="none"
