/** Stamp (تمبر) domain types — /api/stamps/ */
...
export interface StampPurchaseRecord {
  id: number;
  purchase_date?: string | null;
  location?: string;
  seller?: string;
...
export interface StampValuationRecord {
  id: number;
  value: string;
  currency?: Currency;
