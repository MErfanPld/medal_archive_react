...
export default function MuseumBanknoteArchivePage() {
      ...
      <header className="dm-vault">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-24 lg:px-10">
          ...
          <p className="mt-6 max-w-md text-sm leading-7 text-white/55">
            تالار اسکناس‌ها — کاغذ، نقش و تاریخ اقتصاد.
          </p>
            ...
            <>
              <div className="grid grid-cols-2 gap-x-6 gap-y-12 sm:gap-x-10 lg:grid-cols-3">
                {items.map((c) => {
                  ...
                  return (
                    <Link key={c.id} href={`/museum/banknotes/${c.id}`} className="group text-center">
                      ...
                      <p className="dm-label mt-5 text-white/30">
                        {c.catalog_number ? `BN / ${c.catalog_number}` : (c.material || c.country || "—")}
                      </p>
