...
export default function SealsPage() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ["seals", page, search, category, authenticity],
    queryFn: () =>
      getSeals({
        page,
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          icon={<Hexagon className="size-10" />}
          action={
            canCreate ? (
              <Button asChild>
                    ...
                    >
                      <td className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <Link
                              href={`/admin/seals/${c.id}`}
                              className="font-medium hover:text-primary"
                            >
                              {c.name}
                            </Link>
                            <p className="text-xs text-text-muted">
                              {c.catalog_number || c.seal_type || c.material || "—"}
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="p-3">
                        <div className="flex items-center gap-1">
                          <Button variant="ghost" size="sm" asChild>
                            <Link href={`/admin/seals/${c.id}`} aria-label="مشاهده">
                ...
                <Card key={c.id} className="overflow-hidden">
                  <div className="flex h-36 items-center justify-center bg-surface-muted">
                    {resolvePrimaryImage(c) ? (
                      ...
                      <Hexagon className="size-10 text-text-subtle" />
                    )}
                  </div>
